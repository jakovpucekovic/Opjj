...
/**
 *	An {@link IWebWorker} which creates a HTML page with
 *	current time displayed. Gives a different message depending
 *	if a parameter called "name" was provided in URL that
 *	started this worker.
 * 
